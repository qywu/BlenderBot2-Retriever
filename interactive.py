...
def setup_args(parser=None):
    if parser is None:
        parser = ParlaiParser(True, True, 'Interactive chat with a model on the command line')
...
if __name__ == '__main__':
    random.seed(42)
    Interactive.main(
        "--task", "blended_skill_talk", "--model-file", "zoo:blenderbot2/blenderbot2_3B/model", "--search-server",
